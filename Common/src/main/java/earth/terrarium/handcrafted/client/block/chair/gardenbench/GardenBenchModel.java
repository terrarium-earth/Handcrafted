package earth.terrarium.handcrafted.client.block.chair.gardenbench;
...
public class GardenBenchModel extends BaseModel {
    public static final ModelLayerLocation LAYER_LOCATION_SINGLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_single"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_CORNER = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_corner"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_INVERTED_CORNER = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_inverted_corner"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_LEFT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_left"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_MIDDLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_middle"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_RIGHT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "garden_bench_right"), "main");

    public GardenBenchModel(ModelPart root) {
        super(root);
    }
    ...
    public static void register(HandcraftedClient.LayerDefinitionRegistry registry) {
        registry.register(LAYER_LOCATION_SINGLE, GardenBenchModel::benchSingleLayer);
        registry.register(LAYER_LOCATION_CORNER, GardenBenchModel::benchCornerLayer);
        registry.register(LAYER_LOCATION_INVERTED_CORNER, GardenBenchModel::benchInvertedCornerLayer);
        registry.register(LAYER_LOCATION_LEFT, GardenBenchModel::benchLeftLayer);
        registry.register(LAYER_LOCATION_MIDDLE, GardenBenchModel::benchMiddleLayer);
        registry.register(LAYER_LOCATION_RIGHT, GardenBenchModel::benchRightLayer);
    }
}
