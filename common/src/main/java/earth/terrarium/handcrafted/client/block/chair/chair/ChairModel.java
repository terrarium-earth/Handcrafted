...
public class ChairModel extends BaseModel {
    ...
    public static LayerDefinition singleLayer() {
        ...
        PartDefinition cube_r2 = chair.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 14).addBox(-1.0F, -10.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -17.8976F, 6.3448F, -0.0873F, 0.0F, 0.0F));

        PartDefinition cube_r3 = chair.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(12, 14).addBox(-2.0F, -10.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -17.8976F, 6.3448F, -0.0873F, 0.0F, 0.0F));
    ...
    public static void register(HandcraftedClient.LayerDefinitionRegistry registry) {
        registry.register(LAYER_LOCATION, ChairModel::singleLayer);
    }
}
