...
public class DiningBenchModel extends BaseModel {
    public static final ModelLayerLocation LAYER_LOCATION_SINGLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "dining_bench_single"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_LEFT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "dining_bench_left"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_MIDDLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "dining_bench_middle"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_RIGHT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "dining_bench_right"), "main");

    public DiningBenchModel(ModelPart root) {
        super(root);
    }
    ...
    public static void register(HandcraftedClient.LayerDefinitionRegistry registry) {
        registry.register(LAYER_LOCATION_SINGLE, DiningBenchModel::benchSingleLayer);
        registry.register(LAYER_LOCATION_LEFT, DiningBenchModel::benchLeftLayer);
        registry.register(LAYER_LOCATION_MIDDLE, DiningBenchModel::benchMiddleLayer);
        registry.register(LAYER_LOCATION_RIGHT, DiningBenchModel::benchRightLayer);
    }
}
