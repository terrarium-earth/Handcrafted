...
public class DiningBenchRenderer implements BlockEntityRenderer<DiningBenchBlockEntity> {
    ...
    public void render(DiningBenchBlockEntity entity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        render(BuiltInRegistries.BLOCK.getKey(entity.getBlockState().getBlock()), model, entity.getBlockState().getValue(DiningBenchBlock.FACING), poseStack, bufferSource, packedLight, packedOverlay);
    }
    ...
    public static class ItemRenderer extends BlockEntityWithoutLevelRenderer {
        ...
        public void renderByItem(ItemStack stack, ItemDisplayContext itemDisplayContext, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
            ...
            render(BuiltInRegistries.ITEM.getKey(stack.getItem()), model, Direction.SOUTH, poseStack, buffer, packedLight, packedOverlay);
        }
    }
}
