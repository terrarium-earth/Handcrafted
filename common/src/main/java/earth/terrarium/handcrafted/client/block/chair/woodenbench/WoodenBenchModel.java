...
public class WoodenBenchModel extends BaseModel {
    public static final ModelLayerLocation LAYER_LOCATION_SINGLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_single"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_CORNER = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_corner"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_INVERTED_CORNER = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_inverted_corner"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_LEFT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_left"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_MIDDLE = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_middle"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_RIGHT = new ModelLayerLocation(new ResourceLocation(Handcrafted.MOD_ID, "wooden_bench_right"), "main");

    public WoodenBenchModel(ModelPart root) {
        super(root);
    }
    ...
    public static void register(HandcraftedClient.LayerDefinitionRegistry registry) {
        registry.register(LAYER_LOCATION_SINGLE, WoodenBenchModel::benchSingleLayer);
        registry.register(LAYER_LOCATION_CORNER, WoodenBenchModel::benchCornerLayer);
        registry.register(LAYER_LOCATION_INVERTED_CORNER, WoodenBenchModel::benchInvertedCornerLayer);
        registry.register(LAYER_LOCATION_LEFT, WoodenBenchModel::benchLeftLayer);
        registry.register(LAYER_LOCATION_MIDDLE, WoodenBenchModel::benchMiddleLayer);
        registry.register(LAYER_LOCATION_RIGHT, WoodenBenchModel::benchRightLayer);
    }
}
