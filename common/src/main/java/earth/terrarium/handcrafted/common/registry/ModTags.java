...
public class ModTags {
    ...
    public static class Paintings {
        public static final TagKey<PaintingVariant> PAINTINGS = TagKey.create(Registry.PAINTING_VARIANT_REGISTRY, new ResourceLocation(Handcrafted.MOD_ID, "paintings"));
    }
}