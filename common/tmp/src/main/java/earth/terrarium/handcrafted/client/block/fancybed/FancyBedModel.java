...
public class FancyBedModel extends BaseModel {
    ...
    public FancyBedModel(ModelPart root) {
        super(root);
    }
    ...
    public static void register(HandcraftedClient.LayerDefinitionRegistry registry) {
        registry.register(LAYER_LOCATION_SINGLE, FancyBedModel::bedSingle);
        registry.register(LAYER_LOCATION_DOUBLE_LEFT, FancyBedModel::bedDoubleLeft);
        registry.register(LAYER_LOCATION_DOUBLE_MIDDLE, FancyBedModel::bedDoubleMiddle);
        registry.register(LAYER_LOCATION_DOUBLE_RIGHT, FancyBedModel::bedDoubleRight);
    }
}
