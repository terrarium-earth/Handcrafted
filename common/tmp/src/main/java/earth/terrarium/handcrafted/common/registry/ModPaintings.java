...
public class ModPaintings {
    ...
    public static final Supplier<PaintingVariant> BROKEN_BIRCHES_LEFT_SIDEPANEL = register("broken_birches_left_sidepanel", () -> new PaintingVariant(16, 32));
    ...
    public static final Supplier<PaintingVariant> FLOWER_IN_THE_DARKNESS = register("flower_in_the_darkness", () -> new PaintingVariant(16, 32));
